...
class AndTrigger(Trigger):
    ...
    def evaluate(self, story):
        t1 = self.trigger1.evaluate(story)
        t2 = self.trigger2.evaluate(story)
...
class OrTrigger(Trigger):
    ...
    def evaluate(self, story):
        t1 = self.trigger1.evaluate(Trigger)
        t2 = self.trigger2.evaluate(Trigger)
...
def filterStories(stories, triggerlist):
    ...
    story_list = []
    for item in stories:
        for element in triggerlist:
            if element.evaluate(item):
                story_list.append(item)
            else:
                pass
    return set(story_list)
...
def main_thread(master):
    ...
    try:
        ...
        #triggerlist = readTriggerConfig("/Users/karenyang/Documents/6.00.1x/ProblemSet7/triggers.txt")
